...
async def motivational_unicorn ():
    possible_responses = [
        ...
        'YOU CAN DO IT!',
        'I am so proud of you! You are creating something out of nothing and that is a huge deal! No matter what happens, you started something big and no one can take that away.',
